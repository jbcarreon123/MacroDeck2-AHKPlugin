...
{
    public partial class RunScriptv2 : ActionConfigControl
    {
        PluginAction pluginAction;

        public RunScriptv2(PluginAction pluginAction)
        {
            this.pluginAction = pluginAction;
            InitializeComponent();
            label1.Text = PluginLanguageManager.PluginStrings.RunScriptv2Path;
            label2.Text = PluginLanguageManager.PluginStrings.RunScriptv2Note;
        ...
        public override bool OnActionSave()
        {
            ...
            else
            {
                if (File.Exists(textBox1.Text))
                {
                    ...
                    {
                        MacroDeckLogger.Info(PluginInstance.Main, $"Saved RunScriptv2 action config with path: {textBox1.Text}");
        ...
        private void RunScriptv2_Load(object sender, EventArgs e)
        {
